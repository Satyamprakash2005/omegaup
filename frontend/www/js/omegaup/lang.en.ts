...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormPresetOverwriteWarningModalTitle: "Change preset",
  ...
  monacoEditorClipboardError: "Failed to copy code to clipboard",
  monacoEditorCodeEditorContent: "Code editor content",
  monacoEditorCopied: "Copied!",
  monacoEditorCopyCode: "Copy code",
  monacoEditorEnterFullscreen: "Enter fullscreen",
  monacoEditorExitFullscreen: "Exit fullscreen (Esc)",
  monacoEditorExitFullscreenLabel: "Exit fullscreen",
  monacoEditorFontSizeAriaLabel: "Font size",
  monacoEditorFontSizeOption: "%(size)px",
  monacoEditorFullscreen: "Fullscreen (F11)",
  monacoEditorRegionLabel: "Code editor for %(filename)",
  monacoEditorReset: "Reset",
  monacoEditorResetAriaLabel: "Reset to default code",
  monacoEditorResetModalMessage: "Are you sure you want to reset the code to its default state? All changes will be lost.",
  monacoEditorResetModalTitle: "Reset Code",
  monacoEditorResetTitle: "Reset to default code (Ctrl+Shift+R)",
  monacoEditorToolbarAriaLabel: "Editor controls",
  monacoEditorUntitled: "untitled",
  ...
  navProblemStatementEditor: "Problem Statement Editor",
  ...
  readmeAlreadyReported: "You have already reported this README.",
  ...
  userEditPreferredProgrammingLanguagePlaceholder: "Choose the language",
  ...
  wordsPointsForRankTooltip: "These points represent the actual value of this problem. Solving it will decrease its value for everyone.",
